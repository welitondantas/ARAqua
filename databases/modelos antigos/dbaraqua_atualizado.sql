...
--
-- Host: localhost
-- Generation Time: 28-Set-2018 às 03:49
...
CREATE TABLE IF NOT EXISTS `localidade` (
  ...
  `profundidadeAquifero` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `resultado` (
  ...
  `recargaHidrica` float NOT NULL,
  `concentracaoEstimada` float NOT NULL,
...
CREATE TABLE IF NOT EXISTS `solo` (
  ...
  `capacidadeCampo2` float DEFAULT NULL,
  `capacidadeCampo3` float DEFAULT NULL,
  `capacidadeCampo4` float DEFAULT NULL,
  `densidadeSolo1` float NOT NULL,
  `densidadeSolo2` float DEFAULT NULL,
  `densidadeSolo3` float DEFAULT NULL,
  `densidadeSolo4` float DEFAULT NULL,
  `carbonoOrganico1` float NOT NULL,
  `carbonoOrganico2` float DEFAULT NULL,
  `carbonoOrganico3` float DEFAULT NULL,
  `carbonoOrganico4` float DEFAULT NULL,
  PRIMARY KEY (`id`)
